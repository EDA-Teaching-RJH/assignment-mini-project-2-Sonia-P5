def main():
    ...
    def options():
        ...
        print("3. Selection a club(s) (Maximum 2)")
        ...
        def create_new_user():
            ...
            def collecting():
                user=get_user()
                print(f"Information Colelcted: {user.name} {user.last_name}, {user.nationality}, {user.age} years old")
            ...
            def get_user():
                ...
                while True:
                    try:
                        ...
                        print("User numbers to type your age")
                        continue
